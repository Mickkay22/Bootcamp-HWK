...
def mars_scrape():  
    ...
    for i in USGS_images:
        ...
        html = browser.html
        soup = bs(html, 'html.parser')
        Mars_image.append(soup.find_all('li')[0].a['href'])
        Mars_title.append(soup.find_all('h2', class_='title')[0].text)
    ...
    post = {
        ...
        "Facts": Mars_Facts.to_html(classes="table table-striped"),
        "hemi_image_url": Mars_image,
        "hemi_image_title":Mars_title
    }
    print(post)
